...
class CreateTripScreenDemo extends StatefulWidget {
  const CreateTripScreenDemo({super.key});

  @override
  State<CreateTripScreenDemo> createState() => _CreateTripScreenDemoState();
}

class _CreateTripScreenDemoState extends State<CreateTripScreenDemo> {
  ...
  final List<TripMember> _members = [
    TripMember(id: '1', name: 'John Doe', phone: '+1 234 567 8900'),
    TripMember(id: '2', name: 'Jane Smith', phone: '+1 234 567 8901'),
  ];
    ...
    return Row(
      ...
      children: [
        ...
        Switch(
          ...
          activeTrackColor: const Color(0xFF4CAF50), // Green color from image
