// Firebase packages are not installed - all Firebase code is commented out
...
/// Firebase configuration and initialization - DISABLED (Firebase packages not installed)
class FirebaseConfig {
  ...
  /// Initialize Firebase services - DISABLED
  static Future<void> initialize() async {
    ...
    //   rethrow;
    // }
    print('ℹ️ Firebase is disabled - using local SQLite database');
  }

  /// Get Firebase Analytics instance - DISABLED
  // static FirebaseAnalytics? get analytics => _analytics;

  /// Get Firebase Performance instance - DISABLED
  ...
  /// Set user properties for analytics - DISABLED
  ...
  /// Log custom error to Crashlytics - DISABLED
  static Future<void> logError(dynamic error, StackTrace? stackTrace, {String? reason}) async {
    ...
    // }
    print('Error logged (Firebase disabled): $error');
  }

  /// Set user identifier for Crashlytics - DISABLED
  ...
  /// Set custom key-value pairs for Crashlytics - DISABLED
