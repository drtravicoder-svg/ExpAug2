...
// import 'package:image_picker/image_picker.dart'; // Package not installed
// import 'dart:io';
...
class _AddExpenseScreenState extends ConsumerState<AddExpenseScreen> with TickerProviderStateMixin {
  ...
  // File? _receiptImage; // Disabled - image_picker not installed
  String? _location;
  bool _isLoading = false;

  late AnimationController _animationController;
  // final ImagePicker _imagePicker = ImagePicker(); // Disabled - image_picker not installed
  ...
  Future<void> _handleSubmit() async {
    ...
    try {
      ...
      final expense = Expense(
        ...
        payerId: currentUser.id, // Fixed: was paidBy
        title: _titleController.text.trim(),
        description: _descriptionController.text.trim().isNotEmpty ? _descriptionController.text.trim() : null,
        amount: double.parse(_amountController.text),
        currency: 'INR', // Default currency
        category: _selectedCategory!, // Fixed: was categoryId
        date: DateTime.now(), // Expense date
        status: ExpenseStatus.pending,
        receiptPath: null, // Fixed: was receiptUrl. TODO: Upload receipt if available
  ...
  // Image picker methods disabled - image_picker package not installed
  /*
  ...
  */
  ...
  void _showImagePickerOptions() {
    // Image picker disabled - package not installed
    ScaffoldMessenger.of(context).showSnackBar(
      const SnackBar(
        content: Text('Image picker feature is not available'),
